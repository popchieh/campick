...
//$sql1 = "SELECT ANO FROM FORM WHERE SNO = '".$_SESSION['sno']."'";
$sql = "SELECT a.ANO, b.ANO, b.TITLE, b.DEADLINE FROM FORM AS a NATURAL JOIN ACTIVITY AS b WHERE SNO = '".$_SESSION['sno']."'";

//$sql = "SELECT ANO, TITLE, DEADLINE FROM ACTIVITY WHERE ";
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="Activity_Join.php">查看參與活動</a></li>
            </ul>
          </div><!--/.well -->
        </div><!--/span-->
        <div class="span9">
...
<table id="users" class="table">
  ...
  <tr class="ui-widget-header">
    <th width="130" scope="row">活動</th>
    <th width="100">報名截止日</th>
