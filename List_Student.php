...
$sql = "SELECT SNO, SNAME, SEX, SCHOOLLOCATION FROM STUDENT NATURAL JOIN FORM WHERE ANO = '$ANO'";
...
<table id="users" class="table">
  <thead>
  <tr>
    <th width="100" scope="row">報名者</th>
    <th width="60">性別</th>
    <th width="90">學校地區</th>
    <th width="120">檢視報名表</th>
  </tr>
  </thead>
...
while ($row = mysql_fetch_assoc($result)){
    ...
    $_SESSION['View_Form']= $row["SNO"];

    echo "<tr>";
    echo "<td>".$row["SNAME"]."</td>";
    echo "<td>".$row["SEX"]."</td>";
    echo "<td>".$row["SCHOOLLOCATION"]."</td>";
    echo "<td><a href=List_Form.php?SNO=".$row["SNO"].">按此</a></td>";
    echo "</tr>";  
